...
export const DATA_PROCESSING_REG_SHIFT_IMM_DOCS : InstructionDoc[] = [
    ...
    {name: "TST", syntax: "TST{S}<c> <Rn>, <Rm>{, <shift>}", example: "TSTSEQ R2, R3, LSL #1"},
    {name: "TEQ", syntax: "TEQ{S}<c> <Rn>, <Rm>{, <shift>}", example: "TEQSEQ R2, R3, LSL #1"},
    {name: "CMP", syntax: "CMP{S}<c> <Rn>, <Rm>{, <shift>}", example: "CMPSEQ R2, R3, LSL #1"},
    {name: "CMN", syntax: "CMN{S}<c> <Rn>, <Rm>{, <shift>}", example: "CMNSEQ R2, R3, LSL #1"},
...
export const DATA_PROCESSING_REG_SHIFT_REG_DOCS : InstructionDoc[] = [
    ...
    {name: "TST", syntax: "TST{S}<c> <Rn>, <Rm>, <type> <Rs>", example: "TSTSEQ R2, R3, LSL R4"},
    {name: "TEQ", syntax: "TEQ{S}<c> <Rn>, <Rm>, <type> <Rs>", example: "TEQSEQ R2, R3, LSL R4"},
    {name: "CMP", syntax: "CMP{S}<c> <Rn>, <Rm>, <type> <Rs>", example: "CMPSEQ R2, R3, LSL R4"},
    {name: "CMN", syntax: "CMN{S}<c> <Rn>, <Rm>, <type> <Rs>", example: "CMNSEQ R2, R3, LSL R4"},
...
export const DATA_PROCESSING_IMM_DOCS : InstructionDoc[] = [
    ...
    {name: "TST", syntax: "TST{S}<c> <Rn>, #<const>", example: "TSTSEQ R2, #8"},
    {name: "TEQ", syntax: "TEQ{S}<c> <Rn>, #<const>", example: "TEQSEQ R2, #8"},
    {name: "CMP", syntax: "CMP{S}<c> <Rn>, #<const>", example: "CMPSEQ R2, #8"},
    {name: "CMN", syntax: "CMN{S}<c> <Rn>, #<const>", example: "CMNSEQ R2, #8"},
